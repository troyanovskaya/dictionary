...
export class InstructionPageComponent {
  ...
  text = [{item: 'Для того, щоб перейти на головну сторінку зі словником треба натиснути на «Словник» на панелі навігації.',
    ...
    {item: 'Щоб знайти ціле слово за підрядком, введіть його у пошуковий рядок.',
      img: ['assets/img/img6.jpg']
    },
    {item: 'Щоб знайти всі слова, що починаються на певну літеру, натисніть на літеру із переліку.',
      img: ['assets/img/img5.jpg']
    },
    {item: 'Щоб знайти знайти всі слова, що входять до лексико-тематичної групи чи підгрупи, оберіть один з елементів розкривного списку.',
      img: ['assets/img/img9.jpg', 'assets/img/img8.jpg', 'assets/img/img3.jpg']
    },
    {item: 'Всі види пошуку можна використовувати одночасно, для підвищення точності результатів.',
